...
class ProfileDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final name = capitalizeFirst(userData['name'] ?? 'Unnamed');
    final profession = capitalizeFirst(userData['profession'] ?? 'Not specified');
    final address = capitalizeFirst(userData['address'] ?? 'Not specified');
    final bio = capitalizeFirst(userData['bio'] ?? 'No bio available.');
